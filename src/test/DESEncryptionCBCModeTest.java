...
public class DESEncryptionCBCModeTest {
    ...
    private DESEncryptionMode desEncryptionMode;
    ...
    public void setUp() {
        ...
        desEncryptionMode = new DESEncryptionCBCMode(desEncryptor);
    ...
    public void testEncryptDecrypt() {
        ...
        var ciphertext = desEncryptionMode.encrypt(plaintext, key, iv);
        var decrypted = desEncryptionMode.decrypt(ciphertext, key, iv);
